/*
 * Warm Tower ESP32-S3 Sensor Controller
 * Monitors EC, pH, and water temp
 ...
 * 
 * Note: DHT22 is on Cool Tower only (shared environment)
 */
...
const char* mqtt_client_id = "warm_tower_esp32";

// MQTT Topics (short format)
const char* topic_ec = "/warm/ec";
const char* topic_ph = "/warm/ph";
const char* topic_water_temp = "/warm/water_temp";
const char* topic_led = "/warm/led";
const char* topic_pump = "/warm/pump/command";
